...
export function FloatingCtas() {
  return (
    <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2">
      ...
      <a className="grid h-12 w-12 place-items-center rounded-full bg-slate-900 text-white shadow-lg" href={`tel:${site.phone.replace(/\s+/g, "")}`} aria-label="Call PK Transporters">
